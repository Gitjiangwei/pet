...
public class BadWordUtil2 {
    private final static Logger logger = LoggerFactory.getLogger(BadWordUtil2.class);
    public static String filePath = "dictionary.txt";//敏感词库文件路径
//    public static String filePath = BadWordUtil2.class.getClassLoader().getResource("dictionary.txt").getPath();//敏感词库文件路径
...
//        }
        ...
        try{
            ...
            InputStream resourceAsStream = BadWordUtil2.class.getClassLoader().getResourceAsStream(path);
    ...
    public static void main(String[] args) {
        ...
        String string = "太多的伤感情怀也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
                ...
                + "难过就躺在某一个人的怀里尽情的阐薄一波述心扉或者手机卡复制器一个人一杯红酒一部电影在夜三级片 深人静的晚上，关上电话静静的发呆着。";
