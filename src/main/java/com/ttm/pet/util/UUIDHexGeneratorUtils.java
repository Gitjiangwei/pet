...
//生成随机字符串
public class UUIDHexGeneratorUtils {
    private static String sep = "";
    private static final int IP;
    private static short counter = (short) 0;
    private static final int JVM = (int) (System.currentTimeMillis() >>> 8);
    private static UUIDHexGeneratorUtils uuidgen = new UUIDHexGeneratorUtils();
    static {
        int ipadd;
        try {
    ...
    public static UUIDHexGeneratorUtils getInstance() {
        return uuidgen;
    }
...
//            result = (result << - Byte.MIN_VALUE + (int) bytes);
    ...
    public static void main(String[] args) {
        String id="";
        UUIDHexGeneratorUtils uuid = UUIDHexGeneratorUtils.getInstance();
        /*
        for (int i = 0; i < 100; i++) {
            id = uuid.generate();
        }*/
