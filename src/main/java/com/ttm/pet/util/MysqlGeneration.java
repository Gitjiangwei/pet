...
public class MysqlGeneration {
    ...
    private static final String OUT_PATH = "E:\\\\workspace\\pet";
    private static final String AUTHOR = "cx";

    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private static final String URL = "jdbc:mysql://rm-uf6c9an254r31yl6hio.mysql.rds.aliyuncs.com:3306/pet?autoReconnect=true&useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true";
    private static final String USER_NAME = "pet";
    private static final String PASSWORD = "Aa192939!";
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
            ...
            new StrategyConfig()
                ...
                .setInclude(new String[] {"t_business"}) // 需要生成的表
